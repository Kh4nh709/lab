<?php
    ...
    if(isset($_POST['username']) && isset($_POST['password'])){
        ...
        if ($pos_username !== false || $pos_password !== false){
            die('hack detecd');
        }
        $result = get_username_ch_3($username,$password);
        if($result){
            $flag = get_flag_by_id(3);
        }else{
